...
> **Riferimento design Varco** — Sistema scelto per landing, marketing e dashboard (`apps/web`).
> Fonte upstream: [VoltAgent/awesome-design-md — stripe](https://github.com/VoltAgent/awesome-design-md/tree/main/design-md/stripe).
> Analisi _ispirata_ a Stripe (design.md); non è materiale ufficiale Stripe Inc.
> Vedi anche [design/README.md](../README.md) per le regole d'uso nel progetto.
